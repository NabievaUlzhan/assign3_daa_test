...
public class JSONReader {
    ...
    public static class GraphJson {
        public String id;          // "S1", "M3"...
        public boolean directed;   // всегда false
        public int vertices;       // число вершин
        public List<String> nodes; // имена: "N1"... (можно игнорить и генерить по vertices)
