...
public class GraphGenerator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Dataset extra  = buildDataset("extra",  EXTRA,  'X');
    ...
    private static double pickDensity(String category, int n, Random rnd) {
        switch (category) {
            case "small":  return 40 + rnd.nextDouble() * 20; // 40–60%
            case "medium": return 20 + rnd.nextDouble() * 20; // 20–40%
            case "large":  return 7  + rnd.nextDouble() * 10; // 7–17%
            case "extra":  return 2.5 + rnd.nextDouble() * 4; // 2.5–6.5%
            default:       return 20;
        }
    }
    ...
    public static class Dataset {
        public String category; public List<GraphJson> graphs;
    }
    public static class GraphJson {
        public String id; public boolean directed; public int vertices;
        public List<String> nodes; public List<EdgeJson> edges;
    }
    public static class EdgeJson { public String from; public String to; public int weight;
        public EdgeJson() {}
